...
class AggServer(object):
    ...
    def create_key_pair(self):
        ...
        aux_public_key_arr, aux_secret_key_arr = fe_function.set_up(self.common_param.security_param, 1, self.common_param.G2)
    ...
    def secure_agg(self, kgc_pub_key, skf, C_t, y, T_t_arr):
        ...
        W_t_1 = fe_function.Decrypt(kgc_pub_key_arr, skf, self_sec_key_arr, C_t, y)
        T_t_agg = 1
        for T_t in T_t_arr:
            T_t_agg = T_t_agg * T_t
